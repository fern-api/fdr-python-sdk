...
class WebhookPayloadShape_Object(UniversalBaseModel):
...
class WebhookPayloadShape_Reference(UniversalBaseModel):
    value: TypeReference
...
update_forward_refs(WebhookPayloadShape_Object)
