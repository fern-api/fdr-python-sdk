...
class EndpointPath(UniversalBaseModel):
    parts: typing.List[EndpointPathPart]
    path_parameters: typing_extensions.Annotated[typing.List[PathParameter], FieldMetadata(alias="pathParameters")]
...
update_forward_refs(EndpointPath)
