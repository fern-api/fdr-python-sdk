...
class WebSocketMessageBodyShape_Object(UniversalBaseModel):
...
class WebSocketMessageBodyShape_Reference(UniversalBaseModel):
    value: TypeReference
...
WebSocketMessageBodyShape = typing.Union[WebSocketMessageBodyShape_Object, WebSocketMessageBodyShape_Reference]
update_forward_refs(WebSocketMessageBodyShape_Object)
