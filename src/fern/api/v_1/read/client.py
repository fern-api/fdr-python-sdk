...
class ReadClient:
    ...
    def get_api(
        ...
        """
        _response = self._raw_client.get_api(api_definition_id, request_options=request_options)
...
class AsyncReadClient:
    ...
    async def get_api(
        ...
        async def main() -> None:
            await client.api.v_1.read.get_api(
                api_definition_id=uuid.UUID(
                    "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
                ),
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_api(api_definition_id, request_options=request_options)
        return _response.data
