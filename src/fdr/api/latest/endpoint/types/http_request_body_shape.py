...
from ....v_1.read.type.types.bytes_request import BytesRequest
...
class _Factory:
    ...
    def alias(self, value: TypeReference) -> HttpRequestBodyShape:
        if IS_PYDANTIC_V2:
            return HttpRequestBodyShape(root=_HttpRequestBodyShape.Alias(type="alias", value=value))  # type: ignore
        else:
            return HttpRequestBodyShape(__root__=_HttpRequestBodyShape.Alias(type="alias", value=value))  # type: ignore
