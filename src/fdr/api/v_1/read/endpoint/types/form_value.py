...
from .filename_with_data import FilenameWithData as api_v_1_read_endpoint_types_filename_with_data_FilenameWithData
...
class _Factory:
    ...
    def filename_with_data(self, value: api_v_1_read_endpoint_types_filename_with_data_FilenameWithData) -> FormValue:
        if IS_PYDANTIC_V2:
            return FormValue(
    ...
    def filenames_with_data(
        self, value: typing.List[api_v_1_read_endpoint_types_filename_with_data_FilenameWithData]
    ) -> FormValue:
        if IS_PYDANTIC_V2:
...
class FormValue(UniversalRootModel):
    ...
    def visit(
        ...
        filename_with_data: typing.Callable[
            [api_v_1_read_endpoint_types_filename_with_data_FilenameWithData], T_Result
        ],
        filenames_with_data: typing.Callable[
            [typing.List[api_v_1_read_endpoint_types_filename_with_data_FilenameWithData]], T_Result
        ],
        ...
        if unioned_value.type == "filenameWithData":
            return filename_with_data(
                api_v_1_read_endpoint_types_filename_with_data_FilenameWithData(
...
class _FormValue:
    ...
    class FilenameWithData(api_v_1_read_endpoint_types_filename_with_data_FilenameWithData):
    ...
    class FilenamesWithData(UniversalBaseModel):
        ...
        value: typing.List[api_v_1_read_endpoint_types_filename_with_data_FilenameWithData]
