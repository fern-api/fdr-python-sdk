...
class ExampleEndpointCall(WithDescription):
    ...
    code_examples: typing_extensions.Annotated[CodeExamples, FieldMetadata(alias="codeExamples")]
    code_samples: typing_extensions.Annotated[typing.List[CustomCodeSample], FieldMetadata(alias="codeSamples")]
