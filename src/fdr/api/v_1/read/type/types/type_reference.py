...
class _Factory:
    ...
    def unknown(self) -> TypeReference:
        if IS_PYDANTIC_V2:
            return TypeReference(root=_TypeReference.Unknown(type="unknown"))  # type: ignore
        else:
            return TypeReference(__root__=_TypeReference.Unknown(type="unknown"))  # type: ignore
