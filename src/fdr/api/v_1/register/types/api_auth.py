...
from .basic_auth import BasicAuth as api_v_1_register_types_basic_auth_BasicAuth
from .bearer_auth import BearerAuth as api_v_1_register_types_bearer_auth_BearerAuth
from .header_auth import HeaderAuth
from .o_auth import OAuth as api_v_1_register_types_o_auth_OAuth

T_Result = typing.TypeVar("T_Result")


class _Factory:
    def bearer_auth(self, value: api_v_1_register_types_bearer_auth_BearerAuth) -> ApiAuth:
        if IS_PYDANTIC_V2:
    ...
    def basic_auth(self, value: api_v_1_register_types_basic_auth_BasicAuth) -> ApiAuth:
        if IS_PYDANTIC_V2:
    ...
    def o_auth(self, value: api_v_1_register_types_o_auth_OAuth) -> ApiAuth:
        if IS_PYDANTIC_V2:
...
class ApiAuth(UniversalRootModel):
    ...
    def visit(
        self,
        bearer_auth: typing.Callable[[api_v_1_register_types_bearer_auth_BearerAuth], T_Result],
        basic_auth: typing.Callable[[api_v_1_register_types_basic_auth_BasicAuth], T_Result],
        header: typing.Callable[[HeaderAuth], T_Result],
        o_auth: typing.Callable[[api_v_1_register_types_o_auth_OAuth], T_Result],
    ) -> T_Result:
        unioned_value = self.get_as_union()
        if unioned_value.type == "bearerAuth":
            return bearer_auth(
                api_v_1_register_types_bearer_auth_BearerAuth(
                    **unioned_value.dict(exclude_unset=True, exclude={"type"})
                )
            )
        if unioned_value.type == "basicAuth":
            return basic_auth(
                api_v_1_register_types_basic_auth_BasicAuth(**unioned_value.dict(exclude_unset=True, exclude={"type"}))
            )
...
class _ApiAuth:
    class BearerAuth(api_v_1_register_types_bearer_auth_BearerAuth):
    ...
    class BasicAuth(api_v_1_register_types_basic_auth_BasicAuth):
    ...
    class OAuth(UniversalBaseModel):
        ...
        value: api_v_1_register_types_o_auth_OAuth
